  ...
  return (
    <div className="container-fluid navbar-custom position-sticky top-0 py-3 px-3 px-lg-5 d-flex justify-content-between align-items-center" style={{ zIndex: 10 }}>
      ...
      <div className="d-flex align-items-center gap-3">
        <p className="font-weight-semibold h5">tasks</p>
        <div className="rounded-circle text-white d-flex justify-content-center align-items-center" style={{ width: '40px', height: '40px', backgroundColor: '#c24dd0' }}>G
